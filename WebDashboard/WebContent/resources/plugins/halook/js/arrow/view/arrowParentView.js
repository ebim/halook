...
halook.ArrowParentView = wgp.AbstractView
		.extend({
			...
			_insertInitHtml : function() {
				...
				$("#" + this.$el.attr("id"))
						.append(
								'<div id="jobInfoSpace" class="contentHeader"><div id="jobInfoSpaceHtml"  width="450" height = "60"></div><div id = "jobInfoImage" width="250" height="50"><img src ="' + context + '/resources/images/halook_120x30.png" alt="nopage" ></div></div>'
